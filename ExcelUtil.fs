...
let getPacktLibData =
    ...
    let sales2020 =
        { Q1 = row2020.Q1 :?> double
          Q2 = row2020.Q2 :?> double
          Q3 = row2020.Q3 :?> double
          Q4 = row2020.Q4 :?> double }
    ...
    { QuarterWiseYearlySales.Y2015 = sales2015
      ...
      QuarterWiseYearlySales.Y2020 = sales2020 }
...
let getYearlySales (quarterWiseYearlySales: QuarterWiseYearlySales) =
    let totalSales2015 =
        quarterWiseYearlySales.Y2015.Q1
        + quarterWiseYearlySales.Y2015.Q2
        + quarterWiseYearlySales.Y2015.Q3
        + quarterWiseYearlySales.Y2015.Q4

    let totalSales2016 =
        quarterWiseYearlySales.Y2016.Q1
        + quarterWiseYearlySales.Y2016.Q2
        + quarterWiseYearlySales.Y2016.Q3
        + quarterWiseYearlySales.Y2016.Q4

    let totalSales2017 =
        quarterWiseYearlySales.Y2017.Q1
        + quarterWiseYearlySales.Y2017.Q2
        + quarterWiseYearlySales.Y2017.Q3
        + quarterWiseYearlySales.Y2017.Q4

    let totalSales2018 =
        quarterWiseYearlySales.Y2018.Q1
        + quarterWiseYearlySales.Y2018.Q2
        + quarterWiseYearlySales.Y2018.Q3
        + quarterWiseYearlySales.Y2018.Q4

    let totalSales2019 =
        quarterWiseYearlySales.Y2019.Q1
        + quarterWiseYearlySales.Y2019.Q2
        + quarterWiseYearlySales.Y2019.Q3
        + quarterWiseYearlySales.Y2019.Q4

    let totalSales2020 =
        quarterWiseYearlySales.Y2020.Q1
        + quarterWiseYearlySales.Y2020.Q2
        + quarterWiseYearlySales.Y2020.Q3
        + quarterWiseYearlySales.Y2020.Q4
    ...
    { YearlySales.Y2015 = totalSales2015
      ...
      YearlySales.Y2020 = totalSales2020 }
...
let getYearlySalesForAll
    (packtQuarterlySales: QuarterWiseYearlySales)
    (othersQuarterlySales: QuarterWiseYearlySales)
    (pBooksQuarterlySales: QuarterWiseYearlySales)
    (eBooksQuarterlySales: QuarterWiseYearlySales)
    =
...
let getYearlySalesLabelledByYear (yearlySales: YearlySales) =
    [ "2015", yearlySales.Y2015
      ...
      "2020", yearlySales.Y2020 ]

let getYearlySalesLabelledByYearForAll
    (packtYearlySales: YearlySales)
    (othersYearlySales: YearlySales)
    (pBooksYearlySales: YearlySales)
    (eBooksYearlySales: YearlySales)
    =
    let packtLibSalesWithLabel =
        getYearlySalesLabelledByYear packtYearlySales

    let othersSalesWithLabel =
        getYearlySalesLabelledByYear othersYearlySales

    let pBooksSalesWithLabel =
        getYearlySalesLabelledByYear pBooksYearlySales

    let eBooksSalesWithLabel =
        getYearlySalesLabelledByYear eBooksYearlySales

    (packtLibSalesWithLabel, othersSalesWithLabel, pBooksSalesWithLabel, eBooksSalesWithLabel)

let getYearlySalesLabelledByItemForAll
    (packtYearlySales: YearlySales)
    (othersYearlySales: YearlySales)
    (pBooksYearlySales: YearlySales)
    (eBooksYearlySales: YearlySales)
    =
    let salesWith2015Label =
        [ "2015", packtYearlySales.Y2015
          "2015", othersYearlySales.Y2015
          "2015", pBooksYearlySales.Y2015
          "2015", eBooksYearlySales.Y2015 ]

    let salesWith2016Label =
        [ "2016", packtYearlySales.Y2016
          "2016", othersYearlySales.Y2016
          "2016", pBooksYearlySales.Y2016
          "2016", eBooksYearlySales.Y2016 ]

    let salesWith2017Label =
        [ "2017", packtYearlySales.Y2017
          "2017", othersYearlySales.Y2017
          "2017", pBooksYearlySales.Y2017
          "2017", eBooksYearlySales.Y2017 ]

    let salesWith2018Label =
        [ "2018", packtYearlySales.Y2018
          "2018", othersYearlySales.Y2018
          "2018", pBooksYearlySales.Y2018
          "2018", eBooksYearlySales.Y2018 ]

    let salesWith2019Label =
        [ "2019", packtYearlySales.Y2019
          "2019", othersYearlySales.Y2019
          "2019", pBooksYearlySales.Y2019
          "2019", eBooksYearlySales.Y2019 ]

    let salesWith2020Label =
        [ "2020", packtYearlySales.Y2020
          "2020", othersYearlySales.Y2020
          "2020", pBooksYearlySales.Y2020
          "2020", eBooksYearlySales.Y2020 ]
