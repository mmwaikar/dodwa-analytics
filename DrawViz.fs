...
let drawQuarterWiseChart (sales: QuarterWiseYearlySales, titlePrefix: string) =
    ...
    let options =
        Options(
            title = titlePrefix + " (per quarter per year)",
            hAxis = Axis(title = "Year", titleTextStyle = TextStyle(color = "red")),
            vAxis = Axis(title = "Sales", titleTextStyle = TextStyle(color = "green")),
            seriesType = "bars"
        )
...
let drawYearlyChart
    ...
    [ packtLibSalesWithLabel
      othersSalesWithLabel
      pBooksSalesWithLabel
      eBooksSalesWithLabel ]
    |> Chart.Combo
    |> Chart.WithOptions options
...
let drawYearWiseStackedChart
    ...
    let options =
        Options(
            title = "Sales of Data Oriented Development with AngularJS (stacked)",
            isStacked = true,
            hAxis = Axis(title = "Sales", titleTextStyle = TextStyle(color = "green")),
